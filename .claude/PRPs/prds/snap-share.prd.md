...
| 5 | パスワード保護 + TTL | ルーム作成時パスワード + PBKDF2 + DO Alarm TTL | in-progress | with 6 | 4 | [phase-5-password-protection-ttl.plan.md](../plans/phase-5-password-protection-ttl.plan.md) |
