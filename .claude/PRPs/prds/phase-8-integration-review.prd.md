...
|---|-------|-------------|--------|----------|---------|----------|
| 8.0 | PRD 整理 + Phase 8 ブランチ確立 | snap-share.prd.md desync 解消 / 7.6 plan 移動 / Phase 7.7・7.8・8・9 を table 反映 | complete | - | - | (本 PRD 自体、commits `9748246` `1012c29`) |
| 8.A | Triage 先行 pass | 静的シグナル raw scan / categorize / false positive 除外 / 観点境界の確定 | pending | - | 8.0 | TBD |
| 8.B | 13 観点 deep review | 観点ごとに専門 agent or 手動 review、`reviews/phase-8-{axis}.md` 生成 | pending | with 観点間 | 8.A | TBD |
| 8.C | 統合 report 生成 | 観点間の重複・矛盾 merge / Phase 8.x 候補一覧 + 推奨着手順 | pending | - | 8.B | TBD |
