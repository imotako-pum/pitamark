...
| 8.B | 13 観点 deep review | 観点ごとに専門 agent or 手動 review、`reviews/phase-8-{axis}-review.md` 生成 | in-progress | with 観点間 | 8.A | [plan](../plans/phase-8-integration-review.plan.md) (umbrella) |
