...
| 8.A | Triage 先行 pass | 静的シグナル raw scan / categorize / false positive 除外 / 観点境界の確定 | complete | - | 8.0 | [plan](../plans/phase-8-integration-review.plan.md) (umbrella) / [triage review](../reviews/phase-8-triage-review.md) |
| 8.B | 13 観点 deep review | 観点ごとに専門 agent or 手動 review、`reviews/phase-8-{axis}-review.md` 生成 | complete | with 観点間 | 8.A | [plan](../plans/phase-8-integration-review.plan.md) (umbrella) / 14 review files in `reviews/phase-8-*-review.md` |
| 8.C | 統合 report 生成 | 観点間の重複・矛盾 merge / Phase 8.x 候補一覧 + 推奨着手順 | complete | - | 8.B | [plan](../plans/completed/phase-8-integration-review.plan.md) / [report](../reports/phase-8-integration-review-report.md) |
