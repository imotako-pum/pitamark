...
| 2 | A2: 色変更 UI + Schema 拡張 | AnnotationSchema に color 追加、Toolbar に色パレット、デフォルト赤、ハイライト除外、Yjs マイグレーション | pending | with 1, 3 | - | - |
| 3 | B1: ズーム/パン + fit-to-viewport | Stage scale/position 制御、Cmd+0/1, Space+drag, Cmd+wheel、初期 fit ロジック、座標変換整合 | pending | with 1, 2 | - | - |
