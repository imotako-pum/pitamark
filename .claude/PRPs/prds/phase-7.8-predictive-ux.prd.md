...
- ~~**モバイル(タッチ)向けの予測ジェスチャ** — デスクトップ操作のみ~~ → **2026-05-09 方針転換**: タッチ操作の基本パリティは Phase 10.I で対応 ([`phase-10-i-touch-optimization.prd.md`](./phase-10-i-touch-optimization.prd.md))。ただし**予測ジェスチャ (Auto-next 等)** のタッチ最適化は本 PRD では引き続き対象外で、Phase 10.I 完了後に必要なら別 PRD で起票
