...
2. **CHANGELOG.md 新設**: Keep a Changelog 形式、`v0.9.0-mvp` 起点で Phase 0〜10 milestone を遡及記録、`Unreleased` セクション運用開始。
...
- [ ] **CHANGELOG.md**:
  - [ ] リポジトリルートに新規ファイル
  - [ ] `Unreleased` + `[v0.9.0-mvp] - 2026-05-05` を含む
  - [ ] Phase 0-8 の主な機能を Added/Changed/Fixed/Security のいずれかで分類
- [ ] **法務文書**:
